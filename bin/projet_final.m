...
%% somme de variable similaire pour ne pas qu'elles se marche dessus 
precip_sum_sum = T.precip_2j_sum + T.precip_20j_sum;

%% ajout de relation non-linéaires
T.precip_2j_carre = T.precip_2j_sum .^ 2; %ameliore pas 
T.produit_precipitation = T.precip_20j_sum.*T.precip_2j_sum; %ameliore pas 
